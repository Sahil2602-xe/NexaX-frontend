...
export const GET_WALLET_TRANSACTION_REQUEST = "GET_TRANSACTION_WALLET_REQUEST";
export const GET_WALLET_TRANSACTION_SUCCESS = "GET_TRANSACTION_WALLET_SUCCESS";
export const GET_WALLET_TRANSACTION_FAILURE = "GET_TRANSACTION_WALLET_FAILURE";
